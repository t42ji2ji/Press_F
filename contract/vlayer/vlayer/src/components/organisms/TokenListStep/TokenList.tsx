            ...
            <div className="grid grid-cols-12 gap-4 items-center py-4 px-6 text-sm">
                ...
                <div className="col-span-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-white font-semibold truncate max-w-32" title={token.tokenName}>
                                {token.tokenName}
                            </div>
                ...
                <div className="col-span-1">
                    <Link
                        ...
                        className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white text-xs px-3 py-2 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/50 whitespace-nowrap"
                    >
                        Claim
                    </Link>
                </div>
    ...
    return (
        <div className="w-full h-full flex flex-col">
            ...
            <div className="px-6 py-4 border-b border-gray-700/50">
                <h2 className="text-white text-2xl font-bold mb-2 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
                    🚀 Token Marketplace
                </h2>
